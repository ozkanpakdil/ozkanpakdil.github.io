...
While I was trying to write some code, I realized shortcuts are not working for me because I dont remember eclipse shortcuts anymore, so I remembered there was an intellij to eclipse the keymapper plugin. Here is https://github.com/IntelliJIdeaKeymap4Eclipse/IntelliJIdeaKeymap4Eclipse
