...
2015 I median: 4.90 µs  |  2025 I avg: 3.28 µs  |  Speedup: 1.49x
2015 F median: 144.86 µs  |  2025 F avg: 127.37 µs  |  Speedup: 1.14x
Conclusion (I): Java 25 is faster for the imperative test.
Conclusion (F): Java 25 is faster for the stream test.
...
- Args are still: size warmup iters (for the 2025 part). The 2015 harness always uses the original array of 12 elements.
- Output shows two blocks: “2015-style harness” and “2025 benchmark summary”, plus a Winner line.
- New: it also prints a short "2015 vs 2025 (medians vs avgs)" comparison with speedup factors and a one-line conclusion for I and F, so you can immediately tell if Java 25 is faster on your machine.
